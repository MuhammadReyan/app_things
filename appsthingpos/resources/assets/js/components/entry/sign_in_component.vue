        ...
        <div class="d-flex justify-content-center pt-5">
            <div class="col-sm-12 col-md-6 col-lg-4 col-lg-4">
                ...
                <form @submit.prevent="submit_form" class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-lg" v-bind:disabled="processing == true"> <i class='fa fa-circle-notch fa-spin'  v-if="processing == true"></i> Sign in</button>
                </form>
            </div>
        </div>
    </div>
