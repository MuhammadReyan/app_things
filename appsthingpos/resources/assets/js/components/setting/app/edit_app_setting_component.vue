            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="email" v-model="email" v-validate="{ email: true, max: 150 }" class="form-control form-control-custom" :placeholder="$t('Please enter email')"  autocomplete="off">
